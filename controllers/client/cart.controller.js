...
module.exports.addPost = async (req, res) => {
  try {
    ...
    res.status(500).send('Lỗi máy chủ khi thêm sản phẩm vào giỏ hàng')
  }
}
...
module.exports.delete = async (req, res) => {
  try {
    ...
    res.status(500).send('Lỗi máy chủ khi xóa sản phẩm khỏi giỏ hàng')
  }
}
...
module.exports.update = async (req, res) => {
  try {
    ...
    res.status(500).send('Lỗi máy chủ khi cập nhật số lượng sản phẩm')
  }
}
